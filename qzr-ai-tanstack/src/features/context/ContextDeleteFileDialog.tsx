import {
  useContextDeleteFileDialog,
  type ContextDeleteFileDialogProps,
} from "./contextDeleteFileDialog.brain";

export default function ContextDeleteFileDialog(
  props: ContextDeleteFileDialogProps,
) {
  const { confirmLabel, description, title } =
    useContextDeleteFileDialog(props);
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-context-file-title"
        aria-describedby="delete-context-file-description"
      ...
      >
        <h2 id="delete-context-file-title" className="m-0 text-xl font-black">
          {title}
        </h2>
        <p id="delete-context-file-description" className="mt-2 mb-0">
          {description}
        </p>
